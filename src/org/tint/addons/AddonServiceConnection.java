...
public class AddonServiceConnection implements ServiceConnection {
	...
	public void setAddonServiceConnectionListener(
			AddonServiceConnectionListener listener) {
		mListener = listener;
	}
	...
	public List<Action> onContributedMainMenuItemSelected(String currentTabId,
			String currentTitle, String currentUrl) {
		try {
			return mAddon.onContributedMainMenuItemSelected(currentTabId,
					currentTitle, currentUrl);
		} catch (RemoteException e) {
			e.printStackTrace();
			return null;
	...
	public String getContributedLinkContextMenuItem(String currentTabId,
		...
		try {
			return mAddon.getContributedLinkContextMenuItem(currentTabId,
					hitTestResult, url);
		} catch (RemoteException e) {
			e.printStackTrace();
			return null;
	...
	public List<Action> onContributedLinkContextMenuItemSelected(
		...
		try {
			return mAddon.onContributedLinkContextMenuItemSelected(
	...
	public List<Action> onContributedBookmarkContextMenuItemSelected(
		...
		try {
			return mAddon.onContributedBookmarkContextMenuItemSelected(
					currentTabId, title, url);
		} catch (RemoteException e) {
			e.printStackTrace();
			return null;
		}
	...
	public List<Action> onContributedHistoryContextMenuItemSelected(
			String currentTabId, String title, String url) {
		try {
			return mAddon.onContributedHistoryContextMenuItemSelected(
					currentTabId, title, url);
		} catch (RemoteException e) {
			e.printStackTrace();
			return null;
	...
	public List<Action> onUserConfirm(String currentTabId, int questionId,
		...
		try {
			return mAddon.onUserConfirm(currentTabId, questionId,
					positiveAnswer);
		} catch (RemoteException e) {
			e.printStackTrace();
			return null;
	...
	public List<Action> onUserInput(String currentTabId, int questionId,
		...
		try {
			return mAddon.onUserInput(currentTabId, questionId, cancelled,
					userInput);
		} catch (RemoteException e) {
			e.printStackTrace();
			return null;
	...
	public List<Action> onUserChoice(String currentTabId, int questionId,
		...
		try {
			return mAddon.onUserChoice(currentTabId, questionId, cancelled,
					userChoice);
		} catch (RemoteException e) {
			e.printStackTrace();
			return null;
